...
from spgrasp.modeling.spgrasp_base import NO_OBJ_SCORE, SAM2Base
from spgrasp.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        images, inference_meta = load_video_frames(
        ...
        inference_state["video_height"] = inference_meta["video_height"]
        inference_state["video_width"] = inference_meta["video_width"]
        inference_state["resized_sizes"] = inference_meta["resized_sizes"]
        inference_state["pad_infos"] = inference_meta["pad_infos"]
    ...
    def from_pretrained(cls, model_id: str, **kwargs) -> "SAM2VideoPredictor":
        ...
        """
        from spgrasp.build_spgrasp import build_sam2_video_predictor_hf
    ...
    def add_new_points_or_box(
        ...
        if normalize_coords:
            ...
            resized_w, resized_h = inference_state["resized_sizes"][frame_idx]
            pad_w, pad_h = inference_state["pad_infos"][frame_idx]

            # Denormalize from original video coords to resized-and-padded coords
            points[..., 0] = points[..., 0] * (resized_w / video_W) + pad_w
            points[..., 1] = points[..., 1] * (resized_h / video_H) + pad_h
        ...
        _, video_res_masks = self._get_orig_video_res_output(
            inference_state, consolidated_out["pred_masks"], frame_idx
        )
    ...
    def _get_orig_video_res_output(self, inference_state, any_res_masks, frame_idx):
        ...
        # Upsample to model's input size
        model_input_size_masks = F.interpolate(
            any_res_masks,
            size=(self.image_size, self.image_size),
            mode="nearest",
        )
        ...
        # Crop padding
        cropped_masks = model_input_size_masks[
        ...
        return model_input_size_masks, video_res_masks
    ...
    def _consolidate_temp_output_across_obj(
        ...
        consolidated_out = {
            consolidated_mask_key: torch.full(
                size=(batch_size, self.num_channels, consolidated_H, consolidated_W),
...
class SAM2VideoPredictorVOS(SAM2VideoPredictor):
    ...
    def _forward_sam_heads(
        ...
        obj_ptr = self.obj_ptr_proj(sam_output_token) #need fix as sam2_base
        if self.pred_obj_scores:
